...
export const lightTheme: ThemeColors = buildTheme({
    ...
    tonal: [/*0*/'#f0f0f0', /*50*/'#b6b6b6'], /* min contrast of 10.35 */
    background: ['#eef1ff', '#e1e4f0', '#d5d7e1'], /* min contrast ratio of 14.63 against black text */
    warning: ['#f0c060', '#f7dca6', '#fdf7ec'], /* bg2 has 19.69 contrast ratio with black text */
    text: ['#000000']
});
...
export const highContrastLightTheme: ThemeColors = buildTheme({
    ...
    strokeWidth: 2,
    main: ['#007dff', '#156edf', '#1c60c0', '#2052a2', '#204485'],
    tonal: [/*0*/'#eef1ff', /*50*/'#afb1b6'], /* min contrast of 18.66 */
    background: ['#ffffff', '#f0f0f0', '#e1e1e1'], /* min contrast ratio of 16.05 against black text */
    warning: ['#f0c060', '#f7dca6', '#feedd1'], /* bg2 has 19.59 contrast ratio with black text */
    text: ['#000000']
})
...
export const darkTheme: ThemeColors = buildTheme({
    ...
    background: ['#2f2f2f', '#434343', '#585858'], /* min contrast ratio of 9.89 against white text */
    warning: ['#f0c060', '#f9e5bd', '#5a4929'], /* bg2 has 8.67 contrast ratio with white text */
    text: ['#ffffff']
});
...
export const highContrastDarkTheme: ThemeColors = buildTheme({
    ...
    background: ['#000000', '#1e1e1e', '#353535'], /* min contrast ratio of 12.26 with white text */
    warning: ['#f0c060', '#f9e5bd', '#2f2719'], /* bg2 has 14.73 contrast ratio with white text */
    text: ['#ffffff']
});
