...
// const schemaDirectory = '/Users/matthewauburn/Coding/Java/architecture-as-code/calm';
...
//     });
//     it('should return 400 when the $schema specified in the instantiation is not found', async () =>{
