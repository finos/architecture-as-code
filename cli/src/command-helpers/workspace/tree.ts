...
export function renderGraphAsTree(graph: DependencyGraph, bundlePath: string): string {
    ...
    function buildSubtree(id: string, seen = new Set<string>()): TreeNode {
