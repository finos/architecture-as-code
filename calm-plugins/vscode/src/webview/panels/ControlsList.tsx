                        ...
                        return (
                            <div key={key} style={{ border: '1px solid var(--calm-border)', borderRadius: '4px', marginBottom: '4px' }}>
                                <div style={{ display: 'flex', alignItems: 'center', background: 'var(--calm-bg-secondary)' }}>
                                    <button type="button" onClick={() => toggleControl(key)} style={{ display: 'flex', alignItems: 'center', gap: '5px', flex: 1, padding: '6px 8px', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--calm-fg)' }}>
                                        <span style={{ fontSize: '7px', display: 'inline-block', transform: isExpanded ? 'rotate(90deg)' : 'none' }}>&#9654;</span>
                                        <span style={{ fontSize: '11px', fontWeight: 600, fontFamily: 'monospace' }}>{key}</span>
                                    </button>
