            ...
            'core.json': {
                ...
                defs: {
                    ...
                    decision: {
                        ...
                        required: ['description', 'nodes', 'relationships'],
                    },
                    metadata: {
                        type: 'array',
                        items: {
            ...
            'units.json': {
                ...
                defs: {
                    ...
                    'rate-unit': {
                        type: 'object',
                        description:
                            'A unit representing a rate (e.g., operations per second).',
                        properties: {
                            rate: {
                                type: 'number',
                                minimum: 0,
        ...
        patterns: [
            {
                ...
                versions: {
                    '1-0-0': {
                        $schema:
                            'https://calm.finos.org/calm/schemas/2025-03/meta/calm.json',
        ...
        architectures: [
            {
                ...
                versions: {
                    '1-0-0': {
                        ...
                        $schema:
                            'https://calm.finos.org/calm/namespaces/workshop/patterns/1/versions/1.0.0',
                    },
                },
            },
        ],
