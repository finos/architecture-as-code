...
class TestAuthConfigResourceShould {
    ...
    void return_disabled_config_when_oidc_off() {
        ...
        resource.githubOAuthClientId = Optional.empty();
        ...
        Map<String, Object> github = (Map<String, Object>) body.get("github");
        assertThat(github.get("enabled"), equalTo(false));
    }
    ...
    void return_full_config_for_entra_id_with_github_mode() {
        ...
        resource.githubOAuthClientId = Optional.of("gh-oauth-client");
        ...
        Map<String, Object> github = (Map<String, Object>) body.get("github");
        assertThat(github.get("enabled"), equalTo(true));
        assertThat(github.get("oauthClientId"), equalTo("gh-oauth-client"));
    ...
    @Test
    @SuppressWarnings("unchecked")
    void return_oidc_without_github_for_mongo_mode() {
        resource.oidcTenantEnabled = true;
        resource.databaseMode = "mongo";
    ...
    @Test
    @SuppressWarnings("unchecked")
    void return_github_disabled_when_oauth_client_id_is_blank() {
        resource.oidcTenantEnabled = true;
        resource.databaseMode = "github";
        resource.oidcProvider = Optional.of("entra-id");
        ...
        resource.oidcClientId = Optional.of("client-123");
        resource.oidcScopes = Optional.of("openid profile email");
        resource.githubOAuthClientId = Optional.of("");
