...
<CalmDiagram src="./architectures/directurl-auth-plugin.calm.json" interactive={false}/>
...
<CalmDiagram src="./architectures/illustrative-example.calm.json" interactive={false}/>
...
![Illustrative Example Sequence Diagram](../../static/img/calm-cli/direct-url-authenticated-document-retrieval-1.png)
