...
export const aiIcons: Record<string, string> = {
  ...
  observability: `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M2 11l3-4 3 2 3-5 3 4" stroke-linecap="round" stroke-linejoin="round"/><circle cx="5" cy="7" r="0.8" fill="currentColor" stroke="none"/><circle cx="8" cy="9" r="0.8" fill="currentColor" stroke="none"/><circle cx="11" cy="4" r="0.8" fill="currentColor" stroke="none"/><path d="M2 13.5h12" stroke-linecap="round"/></svg>`,
};
