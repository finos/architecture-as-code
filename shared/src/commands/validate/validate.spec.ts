        ...
        it('should convert the json schema output to the ValidationOutput format', () => {
            const given: ErrorObject[] = [
                {
                    ...
                    'schemaPath': 'https://raw.githubusercontent.com/finos/architecture-as-code/main/calm/draft/2024-10/meta/interface.json#/defs/host-port-interface/properties/port/type',
                    'keyword': 'type',
                    'params': {
                        'type': 'integer'
                    },
            ...
            const expected: ValidationOutput[] = [
                new ValidationOutput(
                    ...
                    'https://raw.githubusercontent.com/finos/architecture-as-code/main/calm/draft/2024-10/meta/interface.json#/defs/host-port-interface/properties/port/type'
                )
            ];
