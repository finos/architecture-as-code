...
describe('validation support functions (MSW)', () => {
...
describe('validate pattern and architecture (MSW)', () => {
    beforeEach(() => {
    ...
    it('throws error when the JSON Schema pattern URL returns a 404', async () => {
        resetHandlers([
            { url: 'http://does-not-exist/api-gateway.json', response: 404 }
        ]);
    ...
    it('throws error when the architecture URL returns a 404', async () => {
        resetHandlers([
            { url: 'http://exist/api-gateway.json', response: { fixture: 'api-gateway.json' } },
            { url: 'https://does-not-exist/api-gateway-implementation.json', response: 404 }
        ]);
    ...
    it('throws error when the architecture file at given URL returns non JSON response', async () => {
        ...
        resetHandlers([
            { url: 'http://exist/api-gateway.json', response: { fixture: 'api-gateway.json' } },
            { url: 'https://url/with/non/json/response', response: markdown }
        ]);
    ...
    it('has error when the architecture does not match the json schema', async () => {
        resetHandlers([
            { url: 'http://exist/api-gateway.json', response: { fixture: 'api-gateway.json' } },
            { url: 'https://exist/api-gateway-implementation.json', response: { fixture: 'api-gateway-implementation-that-does-not-match-schema.json' } }
        ]);
    ...
    it('has error when the architecture does not pass all the spectral validations', async () => {
        ...
        resetHandlers([
            { url: 'http://exist/api-gateway.json', response: { fixture: 'api-gateway.json' } },
            { url: 'https://exist/api-gateway-implementation.json', response: { fixture: 'api-gateway-implementation-that-does-not-pass-the-spectral-validation.json' } }
        ]);
    ...
    it('has error when the pattern does not pass all the spectral validations', async () => {
        ...
        resetHandlers([
            { url: 'http://exist/api-gateway.json', response: { fixture: 'api-gateway.json' } },
            { url: 'https://exist/api-gateway-implementation.json', response: { fixture: 'api-gateway-implementation.json' } }
        ]);
...
describe('validate pattern only (MSW)', () => {
    beforeEach(() => {
        mockRunFunction.mockReturnValue([]);
    });
    ...
    it('has errors when spectral returns no errors, but json schema is invalid', async () => {
        ...
        resetHandlers([
            { url: 'http://exist/api-gateway.json', response: { fixture: 'bad-schema/bad-json-schema.json' } }
        ]);
...
describe('validate - architecture only (MSW)', () => {
    beforeEach(() => {
        mockRunFunction.mockReturnValue([]);
    });
    ...
    it('throw error when the architecture cannot be found', async () => {
        resetHandlers([
            { url: 'http://exist/api-gateway-implementation.json', response: 404 }
        ]);
    ...
    it('return errors when the architecture does not pass all the spectral validations', async () => {
        ...
        resetHandlers([
            { url: 'http://exist/api-gateway-implementation.json', response: { fixture: 'api-gateway-implementation.json' } }
        ]);
