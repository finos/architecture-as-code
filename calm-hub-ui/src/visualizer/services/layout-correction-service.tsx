...
export class LayoutCorrectionService {
    ...
    //Maps nodes to nodes that should render within them
    ...
    /**
     * Adds a layout violation to the map of violations
    ...
    /**
     * Recursive function that updates thenode enclosure map based on parent-child relationships
     * @param currentValue 
     * @param enclosureMap 
     * @param visited 
     */
    ...
    /**
     * Identifies nodes that are not rendered within parents (or grandparents and higher ancestors), as well
     * as nodes rendered within non-ancestors.
     * @param cyRef Reference to cytoscape graph.
     * @param nodes Nodes to search over.
     * @returns An object describing nodes not contained within ancestors, as well as nodes within non-ancestors, along with bounding boxes
     */
     ...
     * @param violations A on object containing the bounding box of the node and related nodes for which its rendered position
