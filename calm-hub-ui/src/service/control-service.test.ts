...
describe('ControlService', () => {
    ...
    describe('fetchDomains', () => {
        it('should call the correct endpoint and return domains from string values', async () => {
            ...
            mock.onGet('/api/calm/domains').reply(200, { values: expected });
        ...
        it('should handle an empty values array', async () => {
            mock.onGet('/api/calm/domains').reply(200, { values: [] });
        ...
        it('should filter out non-string values', async () => {
            mock.onGet('/api/calm/domains').reply(200, { values: ['security', 42, null, 'compliance', undefined] });
    ...
    describe('fetchControlsForDomain', () => {
        ...
        it('should call the correct endpoint and return controls', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls`).reply(200, { values: expectedControls });
        ...
        it('should handle an empty controls array', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls`).reply(200, { values: [] });
        ...
        it('should default to empty array when values is missing', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls`).reply(200, {});
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls`).reply(500, { message: 'Error' });
    ...
    describe('fetchRequirementVersions', () => {
        it('should call the correct endpoint and return versions', async () => {
            ...
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/requirement/versions`).reply(200, { values: expected });
        ...
        it('should handle an empty versions array', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/requirement/versions`).reply(200, { values: [] });
        ...
        it('should default to empty array when values is missing', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/requirement/versions`).reply(200, {});
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/requirement/versions`).reply(500, { message: 'Error' });
    ...
    describe('fetchRequirementForVersion', () => {
        ...
        it('should call the correct endpoint and return the requirement JSON', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/requirement/versions/${version}`).reply(200, requirementSchema);
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/requirement/versions/${version}`).reply(500, { message: 'Error' });
    ...
    describe('fetchConfigurationsForControl', () => {
        ...
        it('should handle an empty configurations array', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations`).reply(200, { values: [] });
        ...
        it('should default to empty array when values is missing', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations`).reply(200, {});
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations`).reply(500, { message: 'Error' });
    ...
    describe('fetchConfigurationVersions', () => {
        it('should call the correct endpoint and return versions', async () => {
            ...
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations/${configId}/versions`).reply(200, { values: expected });
        ...
        it('should handle an empty versions array', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations/${configId}/versions`).reply(200, { values: [] });
        ...
        it('should default to empty array when values is missing', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations/${configId}/versions`).reply(200, {});
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations/${configId}/versions`).reply(500, { message: 'Error' });
    ...
    describe('fetchConfigurationForVersion', () => {
        ...
        it('should call the correct endpoint and return the configuration JSON', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations/${configId}/versions/${version}`).reply(200, configJson);
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/domains/${domain}/controls/${controlId}/configurations/${configId}/versions/${version}`).reply(500, { message: 'Error' });
