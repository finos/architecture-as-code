...
describe('InterfaceService', () => {
    ...
    describe('fetchInterfacesForNamespace', () => {
        ...
        it('should call the correct endpoint and return interfaces', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces`).reply(200, { values: expectedInterfaces });
        ...
        it('should handle an empty interfaces array', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces`).reply(200, { values: [] });
        ...
        it('should default to empty array when values is missing', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces`).reply(200, {});
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces`).reply(500, { message: 'Error' });
    ...
    describe('fetchInterfaceVersions', () => {
        it('should call the correct endpoint and return versions', async () => {
            ...
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces/${interfaceId}/versions`).reply(200, { values: expected });
        ...
        it('should handle an empty versions array', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces/${interfaceId}/versions`).reply(200, { values: [] });
        ...
        it('should default to empty array when values is missing', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces/${interfaceId}/versions`).reply(200, {});
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces/${interfaceId}/versions`).reply(500, { message: 'Error' });
    ...
    describe('fetchInterfaceForVersion', () => {
        ...
        it('should call the correct endpoint and return the interface JSON', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces/${interfaceId}/versions/${version}`).reply(200, interfaceJson);
        ...
        it('should throw an error when backend returns error status', async () => {
            mock.onGet(`/api/calm/namespaces/${namespace}/interfaces/${interfaceId}/versions/${version}`).reply(500, { message: 'Error' });
